...
import cn.sini.cgb.common.wxpay.WXPayConstants.SignType;
...
public class WXPay {
     ...
     * @throws Exception
     */
    public Map<String, String> processResponseXml(String xmlStr , String trans) throws Exception {
        String RETURN_CODE = "return_code";
        String return_code;
        Map<String, String> respData = WXPayUtil.xmlToMap(xmlStr);
        if (respData.containsKey(RETURN_CODE)) {
    ...
    public Map<String, String> transfers(Map<String, String> reqData, int connectTimeoutMs, int readTimeoutMs) throws Exception {
        String url = WXPayConstants.TRANSFERACCOUNTS_URL_SUFFIX;
        String respXml = this.requestWithCert(url, reqData, connectTimeoutMs, readTimeoutMs);
        return this.processResponseXml(respXml,"trans");
    }
} // end class
